...
enum MsgType
{
	...
	Msg_SSEL1_FpQuotation			= 0x00101010,       ///< 上交所L1盘后固定价格行情
	...
	Msg_SSEL2_FpQuotation			= 0x00102010,       ///< 上交所L2盘后固定价格行情
	...
	Msg_SSEL2_ETF					= 0x00102007,		///< 上交所L2 ETF统计数据
	Msg_SSEL2_Tick					= 0x0010200C,       ///< 上交所L2逐笔行情(对外)
	Msg_SSEL2_Tick00				= 0x00102020,       ///< 上交所L2逐笔消息00
	Msg_SSEL2_Tick01				= 0x00102021,       ///< 上交所L2逐笔消息01
	Msg_SSEL2_Tick02				= 0x00102022,       ///< 上交所L2逐笔消息02
	Msg_SSEL2_Tick03				= 0x00102023,       ///< 上交所L2逐笔消息03
	Msg_SSEL2_Tick04				= 0x00102024,       ///< 上交所L2逐笔消息04
	Msg_SSEL2_Tick05				= 0x00102025,       ///< 上交所L2逐笔消息05
	Msg_SSEL2_FpTransaction			= 0x00102011,       ///< 上交所L2盘后固定价格逐笔成交
    ...
    Msg_SSEL2_ShortQuotation        = 0x0010200E,       ///< 上交所L2精简实时行情
    Msg_SSEL2_OrderQueue            = 0x0010200F,       ///< 上交所L2委托队列
	...
	Msg_SZSEL1_FpQuotation			= 0x00201010,       ///< 深交所L1盘后固定价格行情
	...
	Msg_SZSEL2_FpQuotation			= 0x00202010,       ///< 深交所L2盘后固定价格行情
    Msg_SZSEL2_Transaction			= 0x00202002,       ///< 深交所L2逐笔成交 UA202
    Msg_SZSEL2_Index				= 0x00202003,       ///< 深交所L2指数行情 UA104
	Msg_SZSEL2_Tick					= 0x00202004,       ///< 深交所L2逐笔消息(对外)
	Msg_SZSEL2_Tick00				= 0x00202020,       ///< 深交所L2逐笔消息00
	Msg_SZSEL2_Tick01				= 0x00202021,       ///< 深交所L2逐笔消息01
	Msg_SZSEL2_Tick02				= 0x00202022,       ///< 深交所L2逐笔消息02
	Msg_SZSEL2_Tick03				= 0x00202023,       ///< 深交所L2逐笔消息03
	Msg_SZSEL2_Tick04				= 0x00202024,       ///< 深交所L2逐笔消息04
	Msg_SZSEL2_Tick05				= 0x00202025,       ///< 深交所L2逐笔消息05
    ...
    Msg_SZSEL2_ShortQuotation       = 0x0020200E,       ///< 深交所L2精简实时行情
    Msg_SZSEL2_OrderQueue           = 0x0020200F,       ///< 深交所L2委托队列
	...
	Msg_CZCEL2_Quotation			= 0x00502001,		///< 郑商所L2实时行情
	Msg_CZCEL2_MktStatus			= 0x00502005,		///< 郑商所L2市场状态
	Msg_CZCEL2_Status				= 0x00502007,		///< 郑商所L2品种状态
    Msg_CZCEL2_ArbiQuotation        = 0x00502008,       ///< 郑商所L2套利行情
	Msg_CZCEL2_LevelQuotation		= 0x0050200C,		///< 郑商所L2五档深度行情
    Msg_CZCEL2_ArbiLevelQuotation   = 0x0050200d,       ///< 郑商所L2套利五档深度行情
    Msg_DCEL1_Static				= 0x00601000,       ///< 大商所L1静态数据
    Msg_DCEL1_Quotation				= 0x00601001,       ///< 大商所L1实时行情
	...
	Msg_DCE_Index					= 0x00601003,		///< 大商所指数行情
    Msg_DCEL2_Static				= 0x00602000,       ///< 大商所L2静态数据
    Msg_DCEL2_Quotation				= 0x00602001,       ///< 大商所L2实时行情
    ...
    Msg_DCEL2_ArbiQuotation			= 0x00602008,       ///< 大商所L2套利行情
	...
	Msg_GFEXL1_Static				= 0x00A01000,		///< 广期所L1静态数据
	Msg_GFEXL1_Quotation			= 0x00A01001,		///< 广期所L1实时行情
	Msg_GFEXL1_ArbiQuotation		= 0x00A01008,		///< 广期所L1套利行情
	Msg_GFEXL1_OptionParameter		= 0x00A01004,		///< 广期所L1期权参数
	Msg_GFEXL2_Static				= 0x00A02000,		///< 广期所L2静态数据
	Msg_GFEXL2_Quotation			= 0x00A02001,		///< 广期所L2实时行情
	Msg_GFEXL2_ArbiQuotation		= 0x00A02008,		///< 广期所L2套利行情
	Msg_GFEXL2_ArbiOrderQueue		= 0x00A02003,		///< 广期所L2套利委托队列
	Msg_GFEXL2_OrderQueue			= 0x00A0200F,		///< 广期所L2委托队列行情
	Msg_GFEXL2_OrderStatistic		= 0x00A0200A,		///< 广期所L2委托统计行情
	Msg_GFEXL2_RealTimePrice		= 0x00A02009,		///< 广期所L2实时结算价
	Msg_GFEXL2_MarchPriceQty		= 0x00A0200B,		///< 广期所L2分价成交量行情
	Msg_GFEXL2_OptionParameter		= 0x00A02004,		///< 广期所L2期权参数
};
/// 数据分类，多个市场汇总后的分类
enum DataCategory
{
...
enum RetCode
{
	...
	Ret_AccountKickOff          = 13,   ///< 同一账号在2个地方登录,前一个登录被踢掉
};
...
enum FieldID
{
    ...
    FID_WarrantUpLimit          = 1223,         ///< IOPV高精度
	...
	FID_BuyLevelQueue01          = 2201,         ///< 买一档队列
    FID_BuyLevelQueue02          = 2202,         ///< 买一档队列
    FID_BuyLevelQueue03          = 2203,         ///< 买一档队列
    FID_BuyLevelQueue04          = 2204,         ///< 买一档队列
    FID_BuyLevelQueue05          = 2205,         ///< 买一档队列
    FID_BuyLevelQueue06          = 2206,         ///< 买一档队列
    FID_BuyLevelQueue07          = 2207,         ///< 买一档队列
    FID_BuyLevelQueue08          = 2208,         ///< 买一档队列
    FID_BuyLevelQueue09          = 2209,         ///< 买一档队列
    FID_BuyLevelQueue10          = 2210,         ///< 买一档队列
    FID_BuyLevelQueue11          = 2211,         ///< 买一档队列
    FID_BuyLevelQueue12          = 2212,         ///< 买一档队列
    FID_BuyLevelQueue13          = 2213,         ///< 买一档队列
    FID_BuyLevelQueue14          = 2214,         ///< 买一档队列
    FID_BuyLevelQueue15          = 2215,         ///< 买一档队列
    FID_BuyLevelQueue16          = 2216,         ///< 买一档队列
    FID_BuyLevelQueue17          = 2217,         ///< 买一档队列
    FID_BuyLevelQueue18          = 2218,         ///< 买一档队列
    FID_BuyLevelQueue19          = 2219,         ///< 买一档队列
    FID_BuyLevelQueue20          = 2220,         ///< 买一档队列
    FID_BuyLevelQueue21          = 2221,         ///< 买一档队列
    FID_BuyLevelQueue22          = 2222,         ///< 买一档队列
    FID_BuyLevelQueue23          = 2223,         ///< 买一档队列
    FID_BuyLevelQueue24          = 2224,         ///< 买一档队列
    FID_BuyLevelQueue25          = 2225,         ///< 买一档队列
    FID_BuyLevelQueue26          = 2226,         ///< 买一档队列
    FID_BuyLevelQueue27          = 2227,         ///< 买一档队列
    FID_BuyLevelQueue28          = 2228,         ///< 买一档队列
    FID_BuyLevelQueue29          = 2229,         ///< 买一档队列
    FID_BuyLevelQueue30          = 2230,         ///< 买一档队列
    FID_BuyLevelQueue31          = 2231,         ///< 买一档队列
    FID_BuyLevelQueue32          = 2232,         ///< 买一档队列
    FID_BuyLevelQueue33          = 2233,         ///< 买一档队列
    FID_BuyLevelQueue34          = 2234,         ///< 买一档队列
    FID_BuyLevelQueue35          = 2235,         ///< 买一档队列
    FID_BuyLevelQueue36          = 2236,         ///< 买一档队列
    FID_BuyLevelQueue37          = 2237,         ///< 买一档队列
    FID_BuyLevelQueue38          = 2238,         ///< 买一档队列
    FID_BuyLevelQueue39          = 2239,         ///< 买一档队列
    FID_BuyLevelQueue40          = 2240,         ///< 买一档队列
    FID_BuyLevelQueue41          = 2241,         ///< 买一档队列
    FID_BuyLevelQueue42          = 2242,         ///< 买一档队列
    FID_BuyLevelQueue43          = 2243,         ///< 买一档队列
    FID_BuyLevelQueue44          = 2244,         ///< 买一档队列
    FID_BuyLevelQueue45          = 2245,         ///< 买一档队列
    FID_BuyLevelQueue46          = 2246,         ///< 买一档队列
    FID_BuyLevelQueue47          = 2247,         ///< 买一档队列
    FID_BuyLevelQueue48          = 2248,         ///< 买一档队列
    FID_BuyLevelQueue49          = 2249,         ///< 买一档队列
    FID_BuyLevelQueue50          = 2250,         ///< 买一档队列
    FID_SellLevelQueue01         = 2251,         ///< 卖一档队列
    FID_SellLevelQueue02         = 2252,         ///< 卖一档队列
    FID_SellLevelQueue03         = 2253,         ///< 卖一档队列
    FID_SellLevelQueue04         = 2254,         ///< 卖一档队列
    FID_SellLevelQueue05         = 2255,         ///< 卖一档队列
    FID_SellLevelQueue06         = 2256,         ///< 卖一档队列
    FID_SellLevelQueue07         = 2257,         ///< 卖一档队列
    FID_SellLevelQueue08         = 2258,         ///< 卖一档队列
    FID_SellLevelQueue09         = 2259,         ///< 卖一档队列
    FID_SellLevelQueue10         = 2260,         ///< 卖一档队列
    FID_SellLevelQueue11         = 2261,         ///< 卖一档队列
    FID_SellLevelQueue12         = 2262,         ///< 卖一档队列
    FID_SellLevelQueue13         = 2263,         ///< 卖一档队列
    FID_SellLevelQueue14         = 2264,         ///< 卖一档队列
    FID_SellLevelQueue15         = 2265,         ///< 卖一档队列
    FID_SellLevelQueue16         = 2266,         ///< 卖一档队列
    FID_SellLevelQueue17         = 2267,         ///< 卖一档队列
    FID_SellLevelQueue18         = 2268,         ///< 卖一档队列
    FID_SellLevelQueue19         = 2269,         ///< 卖一档队列
    FID_SellLevelQueue20         = 2270,         ///< 卖一档队列
    FID_SellLevelQueue21         = 2271,         ///< 卖一档队列
    FID_SellLevelQueue22         = 2272,         ///< 卖一档队列
    FID_SellLevelQueue23         = 2273,         ///< 卖一档队列
    FID_SellLevelQueue24         = 2274,         ///< 卖一档队列
    FID_SellLevelQueue25         = 2275,         ///< 卖一档队列
    FID_SellLevelQueue26         = 2276,         ///< 卖一档队列
    FID_SellLevelQueue27         = 2277,         ///< 卖一档队列
    FID_SellLevelQueue28         = 2278,         ///< 卖一档队列
    FID_SellLevelQueue29         = 2279,         ///< 卖一档队列
    FID_SellLevelQueue30         = 2280,         ///< 卖一档队列
    FID_SellLevelQueue31         = 2281,         ///< 卖一档队列
    FID_SellLevelQueue32         = 2282,         ///< 卖一档队列
    FID_SellLevelQueue33         = 2283,         ///< 卖一档队列
    FID_SellLevelQueue34         = 2284,         ///< 卖一档队列
    FID_SellLevelQueue35         = 2285,         ///< 卖一档队列
    FID_SellLevelQueue36         = 2286,         ///< 卖一档队列
    FID_SellLevelQueue37         = 2287,         ///< 卖一档队列
    FID_SellLevelQueue38         = 2288,         ///< 卖一档队列
    FID_SellLevelQueue39         = 2289,         ///< 卖一档队列
    FID_SellLevelQueue40         = 2290,         ///< 卖一档队列
    FID_SellLevelQueue41         = 2291,         ///< 卖一档队列
    FID_SellLevelQueue42         = 2292,         ///< 卖一档队列
    FID_SellLevelQueue43         = 2293,         ///< 卖一档队列
    FID_SellLevelQueue44         = 2294,         ///< 卖一档队列
    FID_SellLevelQueue45         = 2295,         ///< 卖一档队列
    FID_SellLevelQueue46         = 2296,         ///< 卖一档队列
    FID_SellLevelQueue47         = 2297,         ///< 卖一档队列
    FID_SellLevelQueue48         = 2298,         ///< 卖一档队列
    FID_SellLevelQueue49         = 2299,         ///< 卖一档队列
    FID_SellLevelQueue50         = 2300,         ///< 卖一档队列

	FID_NAV1					 = 2302,         ///< T-1日基金收益/基金净值
	FID_NAV2					 = 2303,         ///< T-2日基金收益/基金净值
	FID_PriceUpdown				 = 2304,		 ///< 涨跌幅度=今收盘价－昨结算
	FID_SecurityNameLong         = 2305,         ///< 证券名称(长)
	FID_IndexQuotSeq             = 2306,         ///< 指数行情序号
    FID_IndexNo                  = 2307,         ///< 指数编号
