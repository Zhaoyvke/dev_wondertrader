...
///郑商所买卖档位信息，含价、量、笔数3个信息
struct CZCE_BuySellLevelInfo
{
    int Price;                  ///< 价格
    int Volume;                 ///< 量
    int TotalOrderNo;           ///< 委托笔数
};
...
{
    double     Price;               ///< 价格
    long long  PriceBOQty;          ///< 买开数量
    long long  PriceBEQty;          ///< 买平数量
    long long  PriceSOQty;          ///< 卖开数量
    long long  PriceSEQty;          ///< 卖平数量
};
...
struct SSEL2_Static
{
    ...
    char                        SecurityNameEx[60];             ///中文证券名称（长）
	char						Note[100];						///< 备注
	double						NAV1;							///< T-1日基金收益/基金净值
	double						NAV2;							///< T-2日基金收益/基金净值
};
...
struct SSEL2_Quotation
{
    ...
    double              WarrantUpLimit;         ///< IOPV高精度值
...
struct SSEL2_OrderQueue 
{
    ...
    unsigned int        BuyLevelQueue01;                    ///< 买一档队列
    unsigned int        BuyLevelQueue02;                    ///< 买一档队列
    unsigned int        BuyLevelQueue03;                    ///< 买一档队列
    unsigned int        BuyLevelQueue04;                    ///< 买一档队列
    unsigned int        BuyLevelQueue05;                    ///< 买一档队列
    unsigned int        BuyLevelQueue06;                    ///< 买一档队列
    unsigned int        BuyLevelQueue07;                    ///< 买一档队列
    unsigned int        BuyLevelQueue08;                    ///< 买一档队列
    unsigned int        BuyLevelQueue09;                    ///< 买一档队列
    unsigned int        BuyLevelQueue10;                    ///< 买一档队列
    unsigned int        BuyLevelQueue11;                    ///< 买一档队列
    unsigned int        BuyLevelQueue12;                    ///< 买一档队列
    unsigned int        BuyLevelQueue13;                    ///< 买一档队列
    unsigned int        BuyLevelQueue14;                    ///< 买一档队列
    unsigned int        BuyLevelQueue15;                    ///< 买一档队列
    unsigned int        BuyLevelQueue16;                    ///< 买一档队列
    unsigned int        BuyLevelQueue17;                    ///< 买一档队列
    unsigned int        BuyLevelQueue18;                    ///< 买一档队列
    unsigned int        BuyLevelQueue19;                    ///< 买一档队列
    unsigned int        BuyLevelQueue20;                    ///< 买一档队列
    unsigned int        BuyLevelQueue21;                    ///< 买一档队列
    unsigned int        BuyLevelQueue22;                    ///< 买一档队列
    unsigned int        BuyLevelQueue23;                    ///< 买一档队列
    unsigned int        BuyLevelQueue24;                    ///< 买一档队列
    unsigned int        BuyLevelQueue25;                    ///< 买一档队列
    unsigned int        BuyLevelQueue26;                    ///< 买一档队列
    unsigned int        BuyLevelQueue27;                    ///< 买一档队列
    unsigned int        BuyLevelQueue28;                    ///< 买一档队列
    unsigned int        BuyLevelQueue29;                    ///< 买一档队列
    unsigned int        BuyLevelQueue30;                    ///< 买一档队列
    unsigned int        BuyLevelQueue31;                    ///< 买一档队列
    unsigned int        BuyLevelQueue32;                    ///< 买一档队列
    unsigned int        BuyLevelQueue33;                    ///< 买一档队列
    unsigned int        BuyLevelQueue34;                    ///< 买一档队列
    unsigned int        BuyLevelQueue35;                    ///< 买一档队列
    unsigned int        BuyLevelQueue36;                    ///< 买一档队列
    unsigned int        BuyLevelQueue37;                    ///< 买一档队列
    unsigned int        BuyLevelQueue38;                    ///< 买一档队列
    unsigned int        BuyLevelQueue39;                    ///< 买一档队列
    unsigned int        BuyLevelQueue40;                    ///< 买一档队列
    unsigned int        BuyLevelQueue41;                    ///< 买一档队列
    unsigned int        BuyLevelQueue42;                    ///< 买一档队列
    unsigned int        BuyLevelQueue43;                    ///< 买一档队列
    unsigned int        BuyLevelQueue44;                    ///< 买一档队列
    unsigned int        BuyLevelQueue45;                    ///< 买一档队列
    unsigned int        BuyLevelQueue46;                    ///< 买一档队列
    unsigned int        BuyLevelQueue47;                    ///< 买一档队列
    unsigned int        BuyLevelQueue48;                    ///< 买一档队列
    unsigned int        BuyLevelQueue49;                    ///< 买一档队列
    unsigned int        BuyLevelQueue50;                    ///< 买一档队列
    double              SellPrice01;                        ///< 申卖价一
    unsigned long long  SellVolume01;                       ///< 申卖量一
    unsigned int        SellLevelQueueNo01;                 ///< 卖一档揭示委托笔数
    unsigned int        SellLevelQueue01;                   ///< 卖一档队列
    unsigned int        SellLevelQueue02;                   ///< 卖一档队列
    unsigned int        SellLevelQueue03;                   ///< 卖一档队列
    unsigned int        SellLevelQueue04;                   ///< 卖一档队列
    unsigned int        SellLevelQueue05;                   ///< 卖一档队列
    unsigned int        SellLevelQueue06;                   ///< 卖一档队列
    unsigned int        SellLevelQueue07;                   ///< 卖一档队列
    unsigned int        SellLevelQueue08;                   ///< 卖一档队列
    unsigned int        SellLevelQueue09;                   ///< 卖一档队列
    unsigned int        SellLevelQueue10;                   ///< 卖一档队列
    unsigned int        SellLevelQueue11;                   ///< 卖一档队列
    unsigned int        SellLevelQueue12;                   ///< 卖一档队列
    unsigned int        SellLevelQueue13;                   ///< 卖一档队列
    unsigned int        SellLevelQueue14;                   ///< 卖一档队列
    unsigned int        SellLevelQueue15;                   ///< 卖一档队列
    unsigned int        SellLevelQueue16;                   ///< 卖一档队列
    unsigned int        SellLevelQueue17;                   ///< 卖一档队列
    unsigned int        SellLevelQueue18;                   ///< 卖一档队列
    unsigned int        SellLevelQueue19;                   ///< 卖一档队列
    unsigned int        SellLevelQueue20;                   ///< 卖一档队列
    unsigned int        SellLevelQueue21;                   ///< 卖一档队列
    unsigned int        SellLevelQueue22;                   ///< 卖一档队列
    unsigned int        SellLevelQueue23;                   ///< 卖一档队列
    unsigned int        SellLevelQueue24;                   ///< 卖一档队列
    unsigned int        SellLevelQueue25;                   ///< 卖一档队列
    unsigned int        SellLevelQueue26;                   ///< 卖一档队列
    unsigned int        SellLevelQueue27;                   ///< 卖一档队列
    unsigned int        SellLevelQueue28;                   ///< 卖一档队列
    unsigned int        SellLevelQueue29;                   ///< 卖一档队列
    unsigned int        SellLevelQueue30;                   ///< 卖一档队列
    unsigned int        SellLevelQueue31;                   ///< 卖一档队列
    unsigned int        SellLevelQueue32;                   ///< 卖一档队列
    unsigned int        SellLevelQueue33;                   ///< 卖一档队列
    unsigned int        SellLevelQueue34;                   ///< 卖一档队列
    unsigned int        SellLevelQueue35;                   ///< 卖一档队列
    unsigned int        SellLevelQueue36;                   ///< 卖一档队列
    unsigned int        SellLevelQueue37;                   ///< 卖一档队列
    unsigned int        SellLevelQueue38;                   ///< 卖一档队列
    unsigned int        SellLevelQueue39;                   ///< 卖一档队列
    unsigned int        SellLevelQueue40;                   ///< 卖一档队列
    unsigned int        SellLevelQueue41;                   ///< 卖一档队列
    unsigned int        SellLevelQueue42;                   ///< 卖一档队列
    unsigned int        SellLevelQueue43;                   ///< 卖一档队列
    unsigned int        SellLevelQueue44;                   ///< 卖一档队列
    unsigned int        SellLevelQueue45;                   ///< 卖一档队列
    unsigned int        SellLevelQueue46;                   ///< 卖一档队列
    unsigned int        SellLevelQueue47;                   ///< 卖一档队列
    unsigned int        SellLevelQueue48;                   ///< 卖一档队列
    unsigned int        SellLevelQueue49;                   ///< 卖一档队列
    unsigned int        SellLevelQueue50;                   ///< 卖一档队列
};
...
struct SSEL2_Transaction
{
    ...
    unsigned long long  TradeVolume;            ///< 成交数量, 股票：股;权证：份;债券：手
...
struct SSEL2_BondTick
{
	...
	unsigned long long  TickVolume;             ///< 逐笔数量, 手
	double              TradeAmount;            ///< 成交金额,
...
struct SSEIOL1_Static
{
    ...
    char                ContractID[40];                           ///< 合约交易代码 , 合约交易代码17位，按以下顺序编写：1、第1至第6位为数字，取标的证券代码，如工商银行601398，取“601398”；2、第7位为C(Call)或者P(Put)，分别表示认购期权或者认沽期权；3、第8、9位表示到期年份；4、第10、11位表示到期月份；5、第12位期初设为“M”，表示月份合约。当合约首次调整后，“M”修改为 “A”，以表示该合约被调整过一次，如发生第二次调整，则“A”修改为“B”、“M”修改为 “A”，以此类推；6、第13至17位表示期权行权价格.留两位备用
    char                SecurityName[121];                        ///< 期权合约简称（证券名称） , 
    char                SymbolUnderlying[SYMBOL_LEN];             ///< 基础证券代码, 
    ...
    int                 TradeDate;                                ///< 市场日期,交易日
	char                NameExUnderlying[65];                     ///< 基础证券证券名称（长）
};
...
struct SZSEL2_Static
{
	...
	//QTS 3.22 新增创业板
	char            SecurityNameLong[200];              ///< 证券名称(长)
};
...
struct SZSEL2_ShortQuotation 
{
    ...
    double              PERatio1;                           ///< 市盈率 1
    double              PERatio2;                           ///< 市盈率 2
    double              IOPV;                               ///< 基金实时参考净值
    double              TotalSellOrderVolume;               ///< 委托卖出总量
    double              WtAvgSellPrice;                     ///< 加权平均委卖价
    double              SellPrice01;                        ///< 申卖价一
    double              SellVolume01;                       ///< 申卖量一
    double              SellPrice02;                        ///< 申卖价二
    ...
    double              SellPrice05;                        ///< 申卖价五
    double              SellVolume05;                       ///< 申卖量五
    double              SellPrice06;                        ///< 申卖价六
    double              SellVolume06;                       ///< 申卖量六
    double              SellPrice07;                        ///< 申卖价七
    double              SellVolume07;                       ///< 申卖量七
    double              SellPrice08;                        ///< 申卖价八
    double              SellVolume08;                       ///< 申卖量八
    double              SellPrice09;                        ///< 申卖价九
    double              SellVolume09;                       ///< 申卖量九
    double              SellPrice10;                        ///< 申卖价十
    double              SellVolume10;                       ///< 申卖量十
    double              TotalBuyOrderVolume;                ///< 委托买入总量
    double              WtAvgBuyPrice;                      ///< 加权平均买入价
    double              BuyPrice01;                         ///< 申买价一
    double              BuyVolume01;                        ///< 申买量一
    double              BuyPrice02;                         ///< 申买价二
    double              BuyVolume02;                        ///< 申买量二
    ...
    double              BuyPrice05;                         ///< 申买价五
    double              BuyVolume05;                        ///< 申买量五
    double              BuyPrice06;                         ///< 申买价六
    double              BuyVolume06;                        ///< 申买量六
    double              BuyPrice07;                         ///< 申买价七
    double              BuyVolume07;                        ///< 申买量七
    double              BuyPrice08;                         ///< 申买价八
    double              BuyVolume08;                        ///< 申买量八
    double              BuyPrice09;                         ///< 申买价九
    double              BuyVolume09;                        ///< 申买量九
    double              BuyPrice10;                         ///< 申买价十
    double              BuyVolume10;                        ///< 申买量十
};
...
struct SZSEL2_OrderQueue 
{
    ...
    double              SellVolume01;                       ///< 申卖量一
    unsigned int        SellLevelQueueNo01;                 ///< 卖一档揭示委托笔数
    double              SellLevelQueue01;                   ///< 卖一档队列
    double              SellLevelQueue02;                   ///< 卖一档队列
    double              SellLevelQueue03;                   ///< 卖一档队列
    double              SellLevelQueue04;                   ///< 卖一档队列
    double              SellLevelQueue05;                   ///< 卖一档队列
    double              SellLevelQueue06;                   ///< 卖一档队列
    double              SellLevelQueue07;                   ///< 卖一档队列
    double              SellLevelQueue08;                   ///< 卖一档队列
    double              SellLevelQueue09;                   ///< 卖一档队列
    double              SellLevelQueue10;                   ///< 卖一档队列
    double              SellLevelQueue11;                   ///< 卖一档队列
    double              SellLevelQueue12;                   ///< 卖一档队列
    double              SellLevelQueue13;                   ///< 卖一档队列
    double              SellLevelQueue14;                   ///< 卖一档队列
    double              SellLevelQueue15;                   ///< 卖一档队列
    double              SellLevelQueue16;                   ///< 卖一档队列
    double              SellLevelQueue17;                   ///< 卖一档队列
    double              SellLevelQueue18;                   ///< 卖一档队列
    double              SellLevelQueue19;                   ///< 卖一档队列
    double              SellLevelQueue20;                   ///< 卖一档队列
    double              SellLevelQueue21;                   ///< 卖一档队列
    double              SellLevelQueue22;                   ///< 卖一档队列
    double              SellLevelQueue23;                   ///< 卖一档队列
    double              SellLevelQueue24;                   ///< 卖一档队列
    double              SellLevelQueue25;                   ///< 卖一档队列
    double              SellLevelQueue26;                   ///< 卖一档队列
    double              SellLevelQueue27;                   ///< 卖一档队列
    double              SellLevelQueue28;                   ///< 卖一档队列
    double              SellLevelQueue29;                   ///< 卖一档队列
    double              SellLevelQueue30;                   ///< 卖一档队列
    double              SellLevelQueue31;                   ///< 卖一档队列
    double              SellLevelQueue32;                   ///< 卖一档队列
    double              SellLevelQueue33;                   ///< 卖一档队列
    double              SellLevelQueue34;                   ///< 卖一档队列
    double              SellLevelQueue35;                   ///< 卖一档队列
    double              SellLevelQueue36;                   ///< 卖一档队列
    double              SellLevelQueue37;                   ///< 卖一档队列
    double              SellLevelQueue38;                   ///< 卖一档队列
    double              SellLevelQueue39;                   ///< 卖一档队列
    double              SellLevelQueue40;                   ///< 卖一档队列
    double              SellLevelQueue41;                   ///< 卖一档队列
    double              SellLevelQueue42;                   ///< 卖一档队列
    double              SellLevelQueue43;                   ///< 卖一档队列
    double              SellLevelQueue44;                   ///< 卖一档队列
    double              SellLevelQueue45;                   ///< 卖一档队列
    double              SellLevelQueue46;                   ///< 卖一档队列
    double              SellLevelQueue47;                   ///< 卖一档队列
    double              SellLevelQueue48;                   ///< 卖一档队列
    double              SellLevelQueue49;                   ///< 卖一档队列
    double              SellLevelQueue50;                   ///< 卖一档队列
    double              BuyPrice01;                         ///< 申买价一
    double              BuyVolume01;                        ///< 申买量一
    unsigned int        BuyLevelQueueNo01;                  ///< 买一档揭示委托笔数
    double              BuyLevelQueue01;                    ///< 买一档委托队列
    double              BuyLevelQueue02;                    ///< 买一档委托队列
    double              BuyLevelQueue03;                    ///< 买一档委托队列
    double              BuyLevelQueue04;                    ///< 买一档委托队列
    double              BuyLevelQueue05;                    ///< 买一档委托队列
    double              BuyLevelQueue06;                    ///< 买一档委托队列
    double              BuyLevelQueue07;                    ///< 买一档委托队列
    double              BuyLevelQueue08;                    ///< 买一档委托队列
    double              BuyLevelQueue09;                    ///< 买一档委托队列
    double              BuyLevelQueue10;                    ///< 买一档委托队列
    double              BuyLevelQueue11;                    ///< 买一档委托队列
    double              BuyLevelQueue12;                    ///< 买一档委托队列
    double              BuyLevelQueue13;                    ///< 买一档委托队列
    double              BuyLevelQueue14;                    ///< 买一档委托队列
    double              BuyLevelQueue15;                    ///< 买一档委托队列
    double              BuyLevelQueue16;                    ///< 买一档委托队列
    double              BuyLevelQueue17;                    ///< 买一档委托队列
    double              BuyLevelQueue18;                    ///< 买一档委托队列
    double              BuyLevelQueue19;                    ///< 买一档委托队列
    double              BuyLevelQueue20;                    ///< 买一档委托队列
    double              BuyLevelQueue21;                    ///< 买一档委托队列
    double              BuyLevelQueue22;                    ///< 买一档委托队列
    double              BuyLevelQueue23;                    ///< 买一档委托队列
    double              BuyLevelQueue24;                    ///< 买一档委托队列
    double              BuyLevelQueue25;                    ///< 买一档委托队列
    double              BuyLevelQueue26;                    ///< 买一档委托队列
    double              BuyLevelQueue27;                    ///< 买一档委托队列
    double              BuyLevelQueue28;                    ///< 买一档委托队列
    double              BuyLevelQueue29;                    ///< 买一档委托队列
    double              BuyLevelQueue30;                    ///< 买一档委托队列
    double              BuyLevelQueue31;                    ///< 买一档委托队列
    double              BuyLevelQueue32;                    ///< 买一档委托队列
    double              BuyLevelQueue33;                    ///< 买一档委托队列
    double              BuyLevelQueue34;                    ///< 买一档委托队列
    double              BuyLevelQueue35;                    ///< 买一档委托队列
    double              BuyLevelQueue36;                    ///< 买一档委托队列
    double              BuyLevelQueue37;                    ///< 买一档委托队列
    double              BuyLevelQueue38;                    ///< 买一档委托队列
    double              BuyLevelQueue39;                    ///< 买一档委托队列
    double              BuyLevelQueue40;                    ///< 买一档委托队列
    double              BuyLevelQueue41;                    ///< 买一档委托队列
    double              BuyLevelQueue42;                    ///< 买一档委托队列
    double              BuyLevelQueue43;                    ///< 买一档委托队列
    double              BuyLevelQueue44;                    ///< 买一档委托队列
    double              BuyLevelQueue45;                    ///< 买一档委托队列
    double              BuyLevelQueue46;                    ///< 买一档委托队列
    double              BuyLevelQueue47;                    ///< 买一档委托队列
    double              BuyLevelQueue48;                    ///< 买一档委托队列
    double              BuyLevelQueue49;                    ///< 买一档委托队列
    double              BuyLevelQueue50;                    ///< 买一档委托队列
};
...
struct CZCEL2_Static 
{
    ...
    unsigned int        TradeDate;                          ///< 交易日期
    unsigned int        SecurityType;                       ///< 合约类型
    unsigned int        InstrumentNo;                       ///< 合约编码
    char                Symbol[80];                         ///< 合约代码
    int                 PriceSize;                          ///< 价格精度
    int                 PreClosePrice;                      ///< 昨收价
    int                 PreSettlePrice;                     ///< 昨结算
    int                 PreTotalPosition;                   ///< 昨持仓量
    int                 PriceUpLimit;                       ///< 涨停价
    int                 PriceDownLimit;                     ///< 跌停价
    int                 TradeStatus;                        ///< 合约交易状态
};
...
struct CZCEL2_Quotation 
{
    ...
    int                 HighPrice;                          ///< 最高价
    int                 LowPrice;                           ///< 最低价
    int                 LifeHigh;                           ///< 历史最高成交价格
    int                 LifeLow;                            ///< 历史最低成交价格
    int                 TotalVolume;                        ///< 成交总量
    long long           TotalAmount;                        ///< 成交总额
    int                 TotalPosition;                      ///< 持仓量
    int                 SettlePrice;                        ///< 结算价
    int                 TotalBuyOrderVolume;                ///< 委托买入总量
    int                 WtAvgBuyPrice;                      ///< 加权平均委买价
    int                 TotalSellOrderVolume;               ///< 委托卖出总量
    int                 WtAvgSellPrice;                     ///< 加权平均委卖价
    int                 DeriveBidPrice;                     ///< 组合买入价
    int                 DeriveAskPrice;                     ///< 组合卖出价
    int                 DeriveBidLot;                       ///< 组合买入数量
    int                 DeriveAskLot;                       ///< 组合卖出数量
};
...
struct CZCEL2_LevelQuotation 
{
    ...
    union
    {
        ...
        {
            int                 BuyPrice01;                         ///< 申买价一
            int                 BuyVolume01;                        ///< 申买量一
            int                 TotalBuyOrderNo01;                  ///< 买入总委托笔数
            int                 BuyPrice02;                         ///< 申买价二
            int                 BuyVolume02;                        ///< 申买量二
            int                 TotalBuyOrderNo02;                  ///< 买入总委托笔数
            int                 BuyPrice03;                         ///< 申买价三
            int                 BuyVolume03;                        ///< 申买量三
            int                 TotalBuyOrderNo03;                  ///< 买入总委托笔数
            int                 BuyPrice04;                         ///< 申买价四
            int                 BuyVolume04;                        ///< 申买量四
            int                 TotalBuyOrderNo04;                  ///< 买入总委托笔数
            int                 BuyPrice05;                         ///< 申买价五
            int                 BuyVolume05;                        ///< 申买量五
            int                 TotalBuyOrderNo05;                  ///< 买入总委托笔数
        };
    };
    union
    {
        ...
        struct
        {
            int                 SellPrice01;                        ///< 申卖价一
            int                 SellVolume01;                       ///< 申卖量一
            int                 TotalSellOrderNo01;                 ///< 卖出总委托笔数
            int                 SellPrice02;                        ///< 申卖价二
            int                 SellVolume02;                       ///< 申卖量二
            int                 TotalSellOrderNo02;                 ///< 卖出总委托笔数
            int                 SellPrice03;                        ///< 申卖价三
            int                 SellVolume03;                       ///< 申卖量三
            int                 TotalSellOrderNo03;                 ///< 卖出总委托笔数
            int                 SellPrice04;                        ///< 申卖价四
            int                 SellVolume04;                       ///< 申卖量四
            int                 TotalSellOrderNo04;                 ///< 卖出总委托笔数
            int                 SellPrice05;                        ///< 申卖价五
            int                 SellVolume05;                       ///< 申卖量五
            int                 TotalSellOrderNo05;                 ///< 卖出总委托笔数
        };
    };
};
...
struct DCEL1_Status
{
	int                 LocalTimeStamp;                     ///< 数据接收时间HHMMSSMMM 
	char                QuotationFlag[QUOTATION_FLAG_LEN];  ///< 行情源标志。后续添加。1=上海机房行情源；2=深圳机房行情源
	char                Symbol[130];						///< 品种合约代码
	char				TradeType[8];						///< 交易类型
	char				TradeStatus[8];						///< 当前交易状态
	int					ChgTime;							///< 切换时间
...
struct GFEXL2_ArbiQuotation 
{
    ...
    union
    {
        ...
        struct
        {
            double              BuyPrice01;                         ///< 申买价一
            long long           BuyVolume01;                        ///< 申买量一
            long long           BidImplyQty01;                      ///< 申买推导量一
            double              BuyPrice02;                         ///< 申买价二
            long long           BuyVolume02;                        ///< 申买量二
            long long           BidImplyQty02;                      ///< 申买推导量二
            double              BuyPrice03;                         ///< 申买价三
            long long           BuyVolume03;                        ///< 申买量三
            long long           BidImplyQty03;                      ///< 申买推导量三
            double              BuyPrice04;                         ///< 申买价四
            long long           BuyVolume04;                        ///< 申买量四
            long long           BidImplyQty04;                      ///< 申买推导量四
            double              BuyPrice05;                         ///< 申买价五
            long long           BuyVolume05;                        ///< 申买量五
            long long           BidImplyQty05;                      ///< 申买推导量五
        };
    };
    ...
    union
    {
        ...
        {            
            double              SellPrice01;                        ///< 申卖价一
            long long           SellVolume01;                       ///< 申卖量一
            long long           AskImplyQty01;                      ///< 申卖推导量一
            double              SellPrice02;                        ///< 申卖价二
            long long           SellVolume02;                       ///< 申卖量二
            long long           AskImplyQty02;                      ///< 申卖推导量二
            double              SellPrice03;                        ///< 申卖价三
            long long           SellVolume03;                       ///< 申卖量三
            long long           AskImplyQty03;                      ///< 申卖推导量三
            double              SellPrice04;                        ///< 申卖价四
            long long           SellVolume04;                       ///< 申卖量四
            long long           AskImplyQty04;                      ///< 申卖推导量四
            double              SellPrice05;                        ///< 申卖价五
            long long           SellVolume05;                       ///< 申卖量五
            long long           AskImplyQty05;                      ///< 申卖推导量五
        };
    };
...
struct GFEXL2_OrderQueue 
{
    ...
    char                Symbol[40];                         ///< 合约代码
    double              BuyPrice01;                         ///< 买一价
    long long           BuyLevelQueue01;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue02;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue03;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue04;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue05;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue06;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue07;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue08;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue09;                    ///< 买最优价委托量队列
    long long           BuyLevelQueue10;                    ///< 买最优价委托量队列
    double              SellPrice01;                        ///< 卖一价
    long long           SellLevelQueue01;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue02;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue03;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue04;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue05;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue06;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue07;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue08;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue09;                   ///< 卖最优价委托量队列
    long long           SellLevelQueue10;                   ///< 卖最优价委托量队列
    unsigned long long  BatchNo;                            ///< 发布批次号
};
...
struct GFEXL2_OrderStatistic 
{
    ...
    int                 TradeDate;                          ///< 交易日期
    char                Symbol[80];                         ///< 合约代码
    long long           TotalBuyOrderVolume;                ///< 委托买入总量
    long long           TotalSellOrderVolume;               ///< 委托卖出总量
    double              WtAvgBuyPrice;                      ///< 加权平均委买价
    double              WtAvgSellPrice;                     ///< 加权平均委卖价
    unsigned long long  BatchNo;                            ///< 发布批次号
};
...
struct GFEXL2_MarchPriceQty 
{
    ...
    union
    {
        ...
        {
            double              Price01;                            ///< 价格1
            long long           PriceBOQty01;                       ///< 买开数量
            long long           PriceBEQty01;                       ///< 买平数量
            long long           PriceSOQty01;                       ///< 卖开数量
            long long           PriceSEQty01;                       ///< 卖平数量
            double              Price02;                            ///< 价格2
            long long           PriceBOQty02;                       ///< 买开数量
            long long           PriceBEQty02;                       ///< 买平数量
            long long           PriceSOQty02;                       ///< 卖开数量
            long long           PriceSEQty02;                       ///< 卖平数量
            double              Price03;                            ///< 价格3
            long long           PriceBOQty03;                       ///< 买开数量
            long long           PriceBEQty03;                       ///< 买平数量
            long long           PriceSOQty03;                       ///< 卖开数量
            long long           PriceSEQty03;                       ///< 卖平数量
            double              Price04;                            ///< 价格4
            long long           PriceBOQty04;                       ///< 买开数量
            long long           PriceBEQty04;                       ///< 买平数量
            long long           PriceSOQty04;                       ///< 卖开数量
            long long           PriceSEQty04;                       ///< 卖平数量
            double              Price05;                            ///< 价格5
            long long           PriceBOQty05;                       ///< 买开数量
            long long           PriceBEQty05;                       ///< 买平数量
            long long           PriceSOQty05;                       ///< 卖开数量
            long long           PriceSEQty05;                       ///< 卖平数量
        };
    };
...
struct SSEL2_ETF 
{
    ...
    int                 Time;                               ///< 数据生成时间
    char                Symbol[40];                         ///< 证券代码
    int                 ETFBuyNo;                           ///< ETF申购笔数
    double				ETFBuyVolume;                       ///< ETF申购量
    double              ETFBuyAmount;                       ///< ETF申购额
    int                 ETFSellNo;                          ///< ETF赎回笔数
    double				ETFSellVolume;                      ///< ETF赎回量
    double              ETFSellAmount;                      ///< ETF赎回额
};
...
struct SSEL2_FpTransaction 
{
    ...
    int                 TradeTime;                          ///< 成交时间
    double              TradePrice;                         ///< 成交价格
    long long           TradeVolume;                        ///< 成交数量
    double              TradeAmount;                        ///< 成交金额
    long long           BuyRecID;                           ///< 买方订单号
    long long           SellRecID;                          ///< 卖方订单号
    char                BuySellFlag;                        ///< 内外盘标志
};
...
struct SSEL2_Tick 
{
    ...
    char                QuotationFlag[4];                   ///< 行情源标志
    long long           PacketTimeStamp;                    ///< 包头时间
    long long           RecID;                              ///< 逐笔序号
    int                 Channel;                            ///< 逐笔通道
    char                Symbol[40];                         ///< 证券代码
    int                 TickTime;                           ///< 逐笔时间
    double              TickPrice;                          ///< 逐笔价格
    long long           TickVolume;                         ///< 逐笔数量
    double              TradeAmount;                        ///< 已成交的委托数量/成交金额
    char                TickBSFlag[8];                      ///< 逐笔标识
    char                TickType;                           ///< 类型
    long long           BuyOrderNO;                         ///< 买方订单
    long long           SellOrderNO;                        ///< 卖方订单
...
struct DCE_Index 
{
    ...
    int                 Time;                               ///< 数据生成时间
    char                Symbol[21];                         ///< 合约代码
    char                SecurityName[121];                  ///< 合约名称
    double              PreClosePrice;                      ///< 昨收价
    double              PreSettlePrice;                     ///< 昨结算
    double              OpenPrice;                          ///< 开盘价
    double              LastPrice;                          ///< 最新价
    double              PriceUpdown;                        ///< 涨跌
    double              UpDownRate;                         ///< 涨跌幅
    double              HighPrice;                          ///< 最高价
    double              LowPrice;                           ///< 最低价
    double              LifeHigh;                           ///< 历史最高成交价格
    ...
    double              SettlePrice;                        ///< 结算价
    unsigned long long  BatchNo;                            ///< 发布批次号
    unsigned long long  IndexQuotSeq;                       ///< 指数行情序号
    unsigned long long  IndexNo;                            ///< 指数编号
};
...
struct SSEL1_FpQuotation 
{
    ...
    int                 TradeTime;                          ///< 成交时间
    unsigned long long  TotalVolume;                        ///< 成交总量
    unsigned long long  TotalAmount;                        ///< 成交总额
    unsigned long long  SellVolume01;                       ///< 申卖量
    unsigned long long  BuyVolume01;                        ///< 申买量
};
...
struct SSEL2_FpQuotation 
{
    ...
    int                 WithdrawSellNo;                     ///< 卖出撤单笔数
    long long           WithdrawSellVolume;                 ///< 卖出撤单量
    unsigned int        BuyLevelNo;                         ///< 买盘价位数量
    unsigned long long  BuyVolume01;                        ///< 申买量
    unsigned int        TotalBuyOrderNo01;                  ///< 买入总委托笔数
    unsigned int        BuyLevelQueueNo01;                  ///< 买一档揭示委托笔数
    unsigned int        BuyLevelQueue01;                    ///< 买1档队列
    unsigned int        BuyLevelQueue02;                    ///< 买1档队列
    unsigned int        BuyLevelQueue03;                    ///< 买1档队列
    unsigned int        BuyLevelQueue04;                    ///< 买1档队列
    unsigned int        BuyLevelQueue05;                    ///< 买1档队列
    unsigned int        BuyLevelQueue06;                    ///< 买1档队列
    unsigned int        BuyLevelQueue07;                    ///< 买1档队列
    unsigned int        BuyLevelQueue08;                    ///< 买1档队列
    unsigned int        BuyLevelQueue09;                    ///< 买1档队列
    unsigned int        BuyLevelQueue10;                    ///< 买1档队列
    unsigned int        BuyLevelQueue11;                    ///< 买1档队列
    unsigned int        BuyLevelQueue12;                    ///< 买1档队列
    unsigned int        BuyLevelQueue13;                    ///< 买1档队列
    unsigned int        BuyLevelQueue14;                    ///< 买1档队列
    unsigned int        BuyLevelQueue15;                    ///< 买1档队列
    unsigned int        BuyLevelQueue16;                    ///< 买1档队列
    unsigned int        BuyLevelQueue17;                    ///< 买1档队列
    unsigned int        BuyLevelQueue18;                    ///< 买1档队列
    unsigned int        BuyLevelQueue19;                    ///< 买1档队列
    unsigned int        BuyLevelQueue20;                    ///< 买1档队列
    unsigned int        BuyLevelQueue21;                    ///< 买1档队列
    unsigned int        BuyLevelQueue22;                    ///< 买1档队列
    unsigned int        BuyLevelQueue23;                    ///< 买1档队列
    unsigned int        BuyLevelQueue24;                    ///< 买1档队列
    unsigned int        BuyLevelQueue25;                    ///< 买1档队列
    unsigned int        BuyLevelQueue26;                    ///< 买1档队列
    unsigned int        BuyLevelQueue27;                    ///< 买1档队列
    unsigned int        BuyLevelQueue28;                    ///< 买1档队列
    unsigned int        BuyLevelQueue29;                    ///< 买1档队列
    unsigned int        BuyLevelQueue30;                    ///< 买1档队列
    unsigned int        BuyLevelQueue31;                    ///< 买1档队列
    unsigned int        BuyLevelQueue32;                    ///< 买1档队列
    unsigned int        BuyLevelQueue33;                    ///< 买1档队列
    unsigned int        BuyLevelQueue34;                    ///< 买1档队列
    unsigned int        BuyLevelQueue35;                    ///< 买1档队列
    unsigned int        BuyLevelQueue36;                    ///< 买1档队列
    unsigned int        BuyLevelQueue37;                    ///< 买1档队列
    unsigned int        BuyLevelQueue38;                    ///< 买1档队列
    unsigned int        BuyLevelQueue39;                    ///< 买1档队列
    unsigned int        BuyLevelQueue40;                    ///< 买1档队列
    unsigned int        BuyLevelQueue41;                    ///< 买1档队列
    unsigned int        BuyLevelQueue42;                    ///< 买1档队列
    unsigned int        BuyLevelQueue43;                    ///< 买1档队列
    unsigned int        BuyLevelQueue44;                    ///< 买1档队列
    unsigned int        BuyLevelQueue45;                    ///< 买1档队列
    unsigned int        BuyLevelQueue46;                    ///< 买1档队列
    unsigned int        BuyLevelQueue47;                    ///< 买1档队列
    unsigned int        BuyLevelQueue48;                    ///< 买1档队列
    unsigned int        BuyLevelQueue49;                    ///< 买1档队列
    unsigned int        BuyLevelQueue50;                    ///< 买1档队列
    unsigned int        SellLevelNo;                        ///< 卖盘价位数量
    unsigned long long  SellVolume01;                       ///< 申卖量
    unsigned int        TotalSellOrderNo01;                 ///< 卖出总委托笔数
    unsigned int        SellLevelQueueNo01;                 ///< 卖一档揭示委托笔数
    unsigned int        SellLevelQueue01;                   ///< 卖1档队列
    unsigned int        SellLevelQueue02;                   ///< 卖1档队列
    unsigned int        SellLevelQueue03;                   ///< 卖1档队列
    unsigned int        SellLevelQueue04;                   ///< 卖1档队列
    unsigned int        SellLevelQueue05;                   ///< 卖1档队列
    unsigned int        SellLevelQueue06;                   ///< 卖1档队列
    unsigned int        SellLevelQueue07;                   ///< 卖1档队列
    unsigned int        SellLevelQueue08;                   ///< 卖1档队列
    unsigned int        SellLevelQueue09;                   ///< 卖1档队列
    unsigned int        SellLevelQueue10;                   ///< 卖1档队列
    unsigned int        SellLevelQueue11;                   ///< 卖1档队列
    unsigned int        SellLevelQueue12;                   ///< 卖1档队列
    unsigned int        SellLevelQueue13;                   ///< 卖1档队列
    unsigned int        SellLevelQueue14;                   ///< 卖1档队列
    unsigned int        SellLevelQueue15;                   ///< 卖1档队列
    unsigned int        SellLevelQueue16;                   ///< 卖1档队列
    unsigned int        SellLevelQueue17;                   ///< 卖1档队列
    unsigned int        SellLevelQueue18;                   ///< 卖1档队列
    unsigned int        SellLevelQueue19;                   ///< 卖1档队列
    unsigned int        SellLevelQueue20;                   ///< 卖1档队列
    unsigned int        SellLevelQueue21;                   ///< 卖1档队列
    unsigned int        SellLevelQueue22;                   ///< 卖1档队列
    unsigned int        SellLevelQueue23;                   ///< 卖1档队列
    unsigned int        SellLevelQueue24;                   ///< 卖1档队列
    unsigned int        SellLevelQueue25;                   ///< 卖1档队列
    unsigned int        SellLevelQueue26;                   ///< 卖1档队列
    unsigned int        SellLevelQueue27;                   ///< 卖1档队列
    unsigned int        SellLevelQueue28;                   ///< 卖1档队列
    unsigned int        SellLevelQueue29;                   ///< 卖1档队列
    unsigned int        SellLevelQueue30;                   ///< 卖1档队列
    unsigned int        SellLevelQueue31;                   ///< 卖1档队列
    unsigned int        SellLevelQueue32;                   ///< 卖1档队列
    unsigned int        SellLevelQueue33;                   ///< 卖1档队列
    unsigned int        SellLevelQueue34;                   ///< 卖1档队列
    unsigned int        SellLevelQueue35;                   ///< 卖1档队列
    unsigned int        SellLevelQueue36;                   ///< 卖1档队列
    unsigned int        SellLevelQueue37;                   ///< 卖1档队列
    unsigned int        SellLevelQueue38;                   ///< 卖1档队列
    unsigned int        SellLevelQueue39;                   ///< 卖1档队列
    unsigned int        SellLevelQueue40;                   ///< 卖1档队列
    unsigned int        SellLevelQueue41;                   ///< 卖1档队列
    unsigned int        SellLevelQueue42;                   ///< 卖1档队列
    unsigned int        SellLevelQueue43;                   ///< 卖1档队列
    unsigned int        SellLevelQueue44;                   ///< 卖1档队列
    unsigned int        SellLevelQueue45;                   ///< 卖1档队列
    unsigned int        SellLevelQueue46;                   ///< 卖1档队列
    unsigned int        SellLevelQueue47;                   ///< 卖1档队列
    unsigned int        SellLevelQueue48;                   ///< 卖1档队列
    unsigned int        SellLevelQueue49;                   ///< 卖1档队列
    unsigned int        SellLevelQueue50;                   ///< 卖1档队列
};
