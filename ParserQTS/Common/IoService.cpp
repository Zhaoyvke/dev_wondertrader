...
void IoService::Run()
{
//     SYSTEMTIME BeginSytemTime;
//     SYSTEMTIME EndSytemTime;
//     GetLocalTime(&BeginSytemTime);
    while (!m_stop)
    {
...
//          GetLocalTime(&EndSytemTime);
//          if (BeginSytemTime.wMinute !=EndSytemTime.wMinute)
//          {
//              BeginSytemTime = EndSytemTime;
//          }
