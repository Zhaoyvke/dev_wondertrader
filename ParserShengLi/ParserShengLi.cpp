...
#endif
#ifdef  _WIN32
#pragma comment(lib,"../API/API_SZE3.2_SSE4.3_25436.quote_recv_api_20230227_154536/efh_lev2_api/windows/x64/debug/efh_lev2_api.lib")
#endif //  _WIN32
...
void ParserShengLi::SubscribeMDs(bool isAll)
{
	CodeSet codes;
...
void ParserShengLi::unsubscribe(const CodeSet & vecSymbols)
{
}
